...
namespace AplicacionWeb.DataSetClienteTableAdapters {
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Cliente] SET [Nombre] = @Nombre, [Direccion] = @Direccion, [Telefon" +
                "o] = @Telefono WHERE (([IdCliente] = @Original_IdCliente))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["ClientesConnectionString"].ConnectionString;
        }
        ...
        public virtual int Update(string Nombre, string Direccion, string Telefono, int Original_IdCliente) {
            if ((Nombre == null)) {
                throw new global::System.ArgumentNullException("Nombre");
            }
            else {
